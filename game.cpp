...
Game::Game() : xwing("X Wing", 2, 4), tiefighter("Tie Fighter", 1, 5), soullessone("Soulless One", 3, 6),
...
void Game::assignRacerSymbol(char track[][45], char symbol, int position, int height, int width) {
    switch (position) {
    case 0:
